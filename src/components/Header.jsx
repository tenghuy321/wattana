...
const Header = () => {
    ...
    return (
        <>
            <section className='absolute left-1/2 -translate-x-1/2 w-full flex items-center justify-between h-[3rem] lg:h-[2rem] px-4 max-w-7xl mx-auto bg-white lg:rounded-bl-[20px] lg:rounded-br-[20px] z-10'>
                <div className='hidden lg:flex items-center gap-4'>
                    <div className='flex items-center gap-2 text-[12px]'>
                        <svg className='w-4 h-4' viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M5.5 11C8.53757 11 11 8.53757 11 5.5C11 2.46243 8.53757 0 5.5 0C2.46243 0 0 2.46243 0 5.5C0 8.53757 2.46243 11 5.5 11Z" fill="#2196F3" />
                            <path d="M8.25 6.63713C7.65669 6.63713 7.09088 6.50787 6.56906 6.25281C6.48725 6.21363 6.39237 6.20744 6.30575 6.237C6.21913 6.26725 6.14831 6.3305 6.10844 6.41231L5.86094 6.9245C5.11844 6.49825 4.50244 5.88156 4.0755 5.13906L4.58837 4.89156C4.67087 4.85169 4.73344 4.78087 4.76369 4.69425C4.79325 4.60763 4.78775 4.51275 4.74788 4.43094C4.49213 3.90981 4.36288 3.344 4.36288 2.75C4.36288 2.56025 4.20888 2.40625 4.01913 2.40625H2.75C2.56025 2.40625 2.40625 2.56025 2.40625 2.75C2.40625 5.97231 5.02769 8.59375 8.25 8.59375C8.43975 8.59375 8.59375 8.43975 8.59375 8.25V6.98088C8.59375 6.79113 8.43975 6.63713 8.25 6.63713Z" fill="#FAFAFA" />
                        </svg>
                    ...
                    <div className='flex items-center gap-2 text-[12px]'>
                        <svg className='w-4 h-4' viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M5.5 11C8.53757 11 11 8.53757 11 5.5C11 2.46243 8.53757 0 5.5 0C2.46243 0 0 2.46243 0 5.5C0 8.53757 2.46243 11 5.5 11Z" fill="#2196F3" />
                            <path d="M5.49871 5.77156L2.59961 4.32523V7.19898C2.60001 7.34467 2.65806 7.48428 2.76108 7.5873C2.8641 7.69032 3.0037 7.74837 3.14939 7.74877H7.85061C7.9963 7.74837 8.13591 7.69032 8.23892 7.5873C8.34194 7.48428 8.39999 7.34467 8.40039 7.19898V4.35553L5.49871 5.77156Z" fill="white" />
                            <path d="M5.50129 5.22844L8.40039 3.81347V3.80101C8.39999 3.65532 8.34194 3.51571 8.23892 3.4127C8.13591 3.30968 7.9963 3.25163 7.85061 3.25123H3.14939C3.00706 3.25151 2.87034 3.30684 2.76787 3.40563C2.66539 3.50442 2.6051 3.63901 2.59961 3.78125L5.50129 5.22844Z" fill="white" />
                        </svg>
                    ...
                    <div className='flex items-center gap-2 text-[12px]'>
                        <svg className='w-4 h-4' viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd" clipRule="evenodd" d="M5.5 11C8.52923 11 11 8.52923 11 5.5C11 2.47077 8.52923 0 5.5 0C2.47077 0 0 2.47077 0 5.5C0 8.52923 2.47077 11 5.5 11Z" fill="#2196F3" />
                            <path d="M7.59005 8.3906C7.59005 8.58254 7.37996 8.77908 7.01376 8.92981C6.61125 9.09552 6.07371 9.18661 5.49999 9.18661C4.92627 9.18661 4.38873 9.09552 3.98622 8.92981C3.61987 8.77906 3.40992 8.58254 3.40992 8.3906C3.40992 8.07918 3.96699 7.77202 4.74213 7.65149L5.42127 8.35031C5.44202 8.37152 5.47041 8.38357 5.50001 8.38357C5.52962 8.38342 5.558 8.37152 5.57875 8.35031L6.25774 7.65149C7.03299 7.77202 7.59005 8.07918 7.59005 8.3906ZM3.70714 6.27153C2.71703 5.25244 2.71748 3.59402 3.70806 2.57475C4.18489 2.0839 4.82145 1.81337 5.50029 1.81337C6.17883 1.81352 6.81464 2.08345 7.29099 2.57383C7.29314 2.57596 7.29512 2.57796 7.29724 2.57978C8.28293 3.59934 8.2811 5.25424 7.29189 6.27196L5.49997 8.11637L3.70714 6.27153ZM4.61485 3.46126C4.12675 3.94937 4.12675 4.74371 4.61485 5.23183C5.10296 5.71979 5.897 5.71979 6.38512 5.23183C6.87323 4.74373 6.87323 3.94939 6.38512 3.46126C6.141 3.21729 5.82058 3.09521 5.49999 3.09521C5.1794 3.09521 4.85898 3.21729 4.61485 3.46126Z" fill="white" />
                        </svg>
            ...
            {open && (
                <div
                    className="fixed inset-0 bg-white flex flex-col items-center justify-center gap-10 z-40 w-full h-full animate-fade-slide"
                >
                    <button
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke-linejoin="round" stroke-linecap="round" stroke="#FF3217">
                    ...
                    <ul className="text-[16px] space-y-4 text-center w-[80%] md:w-1/2">
                        <li>
                            <NavLink to='/' className={({ isActive }) => `block py-2 cursor-pointer transition rounded-full ${isActive ? 'bg-[#FF3217] text-[#fff] font-[500] tracking-wider' : 'bg-white'}`}>Home</NavLink>
                        </li>
                        <li>
                        ...
                        <li>
                            <NavLink to='/customization' className={({ isActive }) => `block py-2 cursor-pointer transition rounded-full ${isActive ? 'bg-[#FF3217] text-[#fff] font-[500] tracking-wider' : 'bg-white'}`}>Customization</NavLink>
                        </li>
                        <li>
                            <NavLink to='/contact' className={({ isActive }) => `block py-2 cursor-pointer transition rounded-full ${isActive ? 'bg-[#FF3217] text-[#fff] font-[500] tracking-wider' : 'bg-white'}`}>Contact Us</NavLink>
                        </li>
                    </ul>
                </div>
            )}
