...
const Msg = () => {
  return (
    <div className='w-full max-w-4xl mx-auto flex items-center justify-center gap-10 overflow-hidden'>
        <img data-aos="fade-right" data-aos-duration="1600" src={ceo} alt="ceo" className='w-40 h-40 object-cover object-center' />
        <div data-aos="fade-left" data-aos-duration="1600" className='text-[12px] md:text-[14px]'>
